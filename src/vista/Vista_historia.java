...
public class Vista_historia {
	...
	public void panel_central() {
		...
		panelHistoria.setLayout(new GridLayout(3, 3, 100, 50));//3 columnas, 3 filas, espacios entre el centro de los botones
		panelHistoria.setBorder(new EmptyBorder(80, 30, 70, 20));//espacio entre los botones (arriba,izquierda,abajo,derecha)
		
		JButton btnRevolucion = new JButton("Revolucion");//boton de revolucion
		btnRevolucion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
			}
		});
		panelHistoria.add(btnRevolucion);
		
		JButton btnIndependencia = new JButton("Independiencia");//boton de independencia
		btnIndependencia.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
			}
		});
		panelHistoria.add(btnIndependencia);
		
		JButton btnBatalla = new JButton("Batalla de puebla");//boton de batalla de puebla
		panelHistoria.add(btnBatalla);
		
		JButton btnCaida = new JButton("Caida de tenochtitlan");//boton de caida de tenochtitlan
		panelHistoria.add(btnCaida);
		
		JButton btnGuerra = new JButton("Guerra de los pasteles");//boton guerra de los pasteles
		panelHistoria.add(btnGuerra);
		
		JButton btnCuestionario = new JButton("Cuestionario");//boton de cuestionario
		panelHistoria.add(btnCuestionario);

		Panel_Principal.add(panelHistoria, BorderLayout.CENTER);
