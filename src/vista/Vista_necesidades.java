...
public class Vista_necesidades {
	...
	public void vista_necesidades() {
		...
		btnPersonal.setPreferredSize(new Dimension(tamWid, tamHei)); // Ajustar tamano del boton
		...
		btnEntretenimento.setPreferredSize(new Dimension(tamWid, tamHei)); // Ajustar tamano del boton
		...
		btnAprendizaje.setPreferredSize(new Dimension(tamWid, tamHei)); // Ajustar tamano del boton
		...
		btnRegresar.setPreferredSize(new Dimension(tamWid, tamHei)); // Ajustar tamano del boton
		...
		btnCerrar_sesion.setPreferredSize(new Dimension(tamWid, tamHei)); // Ajustar tamano del boton
	...
	public void panel_central() {
		...
		JPanel panelNecesidades = new JPanel();
	
		panelNecesidades.setLayout(new GridLayout(3, 3, 100, 50));//3 columnas, 3 filas, espacios entre el centro de los botones
		panelNecesidades.setBorder(new EmptyBorder(80, 30, 70, 20));//espacio entre los botones (arriba,izquierda,abajo,derecha)
		
		JButton btnCuidador = new JButton("Llamar cuidador");//boton de llamar al cuidador
		btnCuidador.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
			}
		});
		panelNecesidades.add(btnCuidador);
		
		JButton btnHambre = new JButton("Tengo hambre");//boton de hambre
		btnHambre.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
			}
		});
		panelNecesidades.add(btnHambre);
		
		JButton btnComezon = new JButton("Comezon");//boton de comezon
		panelNecesidades.add(btnComezon);
		
		JButton btnDormir = new JButton("sueño");//boton de sueño
		panelNecesidades.add(btnDormir);
		
		JButton btnBano = new JButton("baño");//boton de baño
		panelNecesidades.add(btnBano);
		
		JButton btnEnfermo = new JButton("Me siento mal");//boton de me siento mal
		panelNecesidades.add(btnEnfermo);
		
		Panel_Principal.add(panelNecesidades, BorderLayout.CENTER);
