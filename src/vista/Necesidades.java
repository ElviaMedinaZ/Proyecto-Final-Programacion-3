...
//		aprendizaje.add(panel_1, BorderLayout.CENTER);
	...
	private void panel_central() {//panel de los botones del centro
		...
		JButton btnComezon = new JButton("Comezón");//boton de certificado
		panel.add(btnComezon);
		
		JButton btnSueno = new JButton("Sueño");//boton de contactos
		panel.add(btnSueno);
		
		JButton btnBano= new JButton("Baño");//boton de editar perfil
		panel.add(btnBano);
