...
public class Vista_entretenimiento {
	...
	public void panel_central() {
		...
		JButton btnPeliculas = new JButton("Películas");//boton de peliculas
		...
		JButton btnNumerico = new JButton("Rompecabezas numérico");//boton de juego rompecabezas numerico
