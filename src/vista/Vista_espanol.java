...
public class Vista_espanol {
	...
	public void panel_central() {
		...
		panelEspanol.setLayout(new GridLayout(3, 3, 100, 50));//3 columnas, 3 filas, espacios entre el centro de los botones
		panelEspanol.setBorder(new EmptyBorder(80, 30, 70, 20));//espacio entre los botones (arriba,izquierda,abajo,derecha)
		
		JButton btnFabula = new JButton("Fabula");//boton de fabula
		btnFabula.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
			}
		});
		panelEspanol.add(btnFabula);
		...
		panelEspanol.add(btnCuento);
		
		JButton btnNoticia = new JButton("Noticia");//boton de noticias
		panelEspanol.add(btnNoticia);
		
		JButton btnLeyenda = new JButton("Leyenda");//boton de leyenda
		panelEspanol.add(btnLeyenda);
		
		JButton btnNovela = new JButton("Novelas");//boton de novelas
		panelEspanol.add(btnNovela);
		
		JButton btnCuestionario = new JButton("Cuestionario");//boton de cuestionario
		panelEspanol.add(btnCuestionario);
		
		Panel_Principal.add(panelEspanol, BorderLayout.CENTER);
